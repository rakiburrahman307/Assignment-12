                ...
                <div className="hero min-h-screen bg-transparent">
                    <div className="hero-content flex-col lg:flex-row">
                        <div className="text-center lg:text-left">
                            ...
                            <p className="py-6">
                                Log in to access your account and manage your stay at our
                                state-of-the-art hostel. Experience comfort, convenience, and a secure
                                environment.
                            </p>
                        </div>
                        ...
                        <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-current rounded-xl">
                            ...
                            <div className="form-control mt-6 flex justify-center items-center">
                                <button onClick={handleLogInWithGoogle} className="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"><svg xmlns="http://www.w3.org/2000/svg" x="500px" y="0px" width="25" height="25" viewBox="0 0 48 48">
