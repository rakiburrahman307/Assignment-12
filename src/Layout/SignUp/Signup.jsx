  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: bgLoaded ? "transparent" : "#ccc" }}
      ></div>
        ...
        <div className='hero min-h-screen bg-transparent'>
          <div className='hero-content flex-col lg:flex-row'>
            <div className='text-center lg:text-left'>
              ...
              <p className='py-6'>
                Create an account to unlock the full experience of our
                state-of-the-art hostel management system. Enjoy the comfort,
                convenience, and security we offer. Your journey with us begins
                here!
              </p>
            </div>
